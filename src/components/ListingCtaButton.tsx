...
export default function ListingCtaButton({ productCode, platform, href }: Props) {
  return (
    <a
      href={href}
      target='_blank'
      rel='nofollow sponsored noopener'
      onClick={() => trackAffiliateClick(productCode, platform, href, 'listing')}
    ...
    >
      ...
      <span className='relative text-sm'>Shop on {shopPlatformLabel(platform)}</span>
